...
/**
 * Root index file function template
 * @author Andy Chau on 21/9/20.
 */
public class RootModuleTemplate {
    private static final String TEMPLATE_NAME = "root.function.vm";
    ...
    public RootModuleTemplate() throws IOException {
